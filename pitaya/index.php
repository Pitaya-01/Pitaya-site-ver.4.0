...
<nav class="navbar navbar-expand-lg navbar-dark" style="z-index: 2;position: fixed; width:100%; margin-top: 1%;background-color: #ffff; box-shadow: 0px 4px 4px #FF548A; border-bottom-left-radius: 30px; border-bottom-right-radius: 30px;">
...
<div class="container-fluid" id="hero" style="margin-top: -2%;padding-top: 5%;justify-content: center; box-shadow: 0px 4px 4px #FF548A; height: 630px; background: linear-gradient(90.05deg, rgba(255, 255, 255, 0) 27.33%, rgba(255, 210, 224, 0.489436) 36.18%, #FFA3C0 45.42%, #FF88AD 51.67%, #FF548A 63.29%, #FF548A 70.48%, #FF548A 81.54%, #FF548A 97.58%);  ">

<div class="row" style="margin-left: 0%">
<p> <!---------------------------------------------- --------------------------------------------------------------------->
  <div class="col-md-7">
    <img src="imgs/logo2.png" width="53%; margin-top: " alt="">
  </div>

  <div class="col-md-4" style="padding-top: 5%; color: #ffffff;">
  <figure class="text-left">
    <h1 class="display-2"><u>O que é PITAYA?</u></h1>
  </figure>
  <figure class="text-left fs-2">
  PITAYA é uma equipe de desenvolvedores criada com o objetivo de desenvolver tecnologias voltadas para o cotidiano das pessoas.
  </figure>
...
<div class="row row d-flex justify-content-center" style="margin-left: 9%">
...
<div class="d-flex justify-content-around" id="geral" style="margin-left: -70px">
  ...
  <div class="container-flex text-center col-md-4">
...
<div class="mb-3" style="max-width: 25%;" style="border: 3px solid #000000;">
...
<footer class="footer text-center pd-0" style="padding:1%">
